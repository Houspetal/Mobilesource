...
import 'package:grade_project/housepital/view/doctor/doctor_views/doctor_appointments.dart';

import '../../../model/bannerModel.dart';
import 'make_advice_screen.dart';

class DoctorCarouselSliderBuilder extends StatelessWidget {
  DoctorCarouselSliderBuilder({super.key});
              ...
              onTap: () {
                index == 0
                    ? Navigator.push(context,
                        ...
                        return const DoctorMakingAdvice();
                      }))
                    : Navigator.push(
                        context,
                        MaterialPageRoute(
